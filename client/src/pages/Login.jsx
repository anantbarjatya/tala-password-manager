      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-8 md:p-10">
          ...
          <button
            ...
            className="w-full py-4 rounded-2xl bg-white/5 border border-white/10 text-white font-medium hover:bg-white/10 disabled:opacity-50 transition-all flex items-center justify-center gap-3"
          >
            {googleLoading ? (
